(function () {
  if (!location.hostname.endsWith("reed.co.uk")) return;
  if (document.getElementById("reedcouk-copy-ui")) return;
  ...
  const sendBtn = makeBtn("Send", "#cf04a9");
  ...
  new MutationObserver(() => {
    if (!document.getElementById("reedcouk-copy-ui")) {
      document.body.appendChild(uiWrapper);
    }
